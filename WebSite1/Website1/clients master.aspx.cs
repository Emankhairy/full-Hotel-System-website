...
public partial class clients_master : System.Web.UI.Page
{
    ...
    {
        cg = new SqlConnection("Data Source=WDS;Initial Catalog=hotel;Integrated Security=True;Connect Timeout=30;Encrypt=False;TrustServerCertificate=False;ApplicationIntent=ReadWrite;MultiSubnetFailover=False");
    }
    ...
    protected void sh_id_Click(object sender, EventArgs e)
    {
        ...
        GridView1.DataBind(); //في هيئه جداولdatabase    عرض البيانات في ال 
        cg.Close();
    }
}